      ...
      <div id="logoAndNav" class="container mt-lg-n2">
        <nav class="js-mega-menu navbar navbar-expand-lg">
          <div class="navbar-nav-wrap">
            <router-link
              to="/"
              class="navbar-brand navbar-nav-wrap-brand"
              aria-label="Front"
            >
            ...
            <div class="navbar-nav-wrap-content d-flex align-items-center">
              ...
              <li class="list-inline-item">
                <div class="hs-unfold">
                  <tippy :interactive="true" :appendTo="body">
                    <a
                      class="js-hs-unfold-invoker btn btn-xs btn-icon btn-ghost-secondary"
                    >
