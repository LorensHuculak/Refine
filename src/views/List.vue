          ...
          <div class="mr-lg-2">
            ...
            <div class="d-flex align-items-center flex-wrap mb-6">
              ...
              <span class="d-inline-block">
                <span class="text-dark font-weight-bold mr-1 font-size-1"
                  >4.87</span
                >
            ...
            <div class="mb-6">
              <a :href="evidenceURI"> List Requirements </a>
            </div>
            <div class="mb-md-7">
              <h1 class="h4">Categories</h1>

              <span class="d-inline-block mr-1 mb-2"
                ><a class="btn btn-xs btn-soft-secondary">Featured</a></span
              >
              <span class="d-inline-block mr-1 mb-2"
              ...
              >
              <span class="d-inline-block mr-1 mb-2"
                ><a class="btn btn-xs btn-soft-secondary">Bitcoin</a></span
              >
              <span class="d-inline-block mr-1 mb-2"
                ><a class="btn btn-xs btn-soft-secondary">Ethereum</a></span
              >
              <span class="d-inline-block mr-1 mb-2"
                ><a class="btn btn-xs btn-soft-secondary">Elon Musk</a></span
              >
            </div>
              ...
              <a class="d-inline-block text-body">
                <div class="media align-items-center">
                  <div class="avatar avatar-xs mr-3">
                    <AccountIcon
                      :address="status?.requester"
                      :size="32"
                    ></AccountIcon>
                  </div>
                  <div class="media-body">
                    <ShortAddress :address="status?.requester"></ShortAddress>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div class="d-flex">
              ...
              ></i>
              <span class="small text-body cursor-pointer" href="#"
                >Challenge this list</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8 col-lg-9 column-divider-md">
          <div class="ml-lg-2">
            <div class="mb-5 row">
              ...
              <div class="col-4">
                <button class="btn btn-primary float-right" @click="openSubmit">
                  Add User
                </button>
              </div>
            </div>
            ...
            <!-- Nav Classic -->
            <ul
              class="nav nav-classic nav-rounded nav-justified border cursor-pointer"
              role="tablist"
            >
              <li
                v-for="tab in tabs"
...
export default {
  ...
  data() {
    return {
      ...
      tabs: [
        {
          component: "ListInfoTab",
          name: "List Info",
          icon: require("@/assets/svg/icons/icon-24.svg"),
        },
        {
          component: "ReviewsTab",
          name: "Reviews",
          icon: require("@/assets/svg/icons/icon-7.svg"),
        },
        {
          component: "DetailsTab",
          name: "Details",
          icon: require("@/assets/svg/icons/icon-1.svg"),
        },
      ],
    };
  },
  ...
  computed: {
    evidenceURI() {
      return (
        ...
        this?.list?.submissionEvidence.fileURI
      );
    },
    ...
    currentProps() {
      if (this.currentTabComponent == "ListInfoTab") {
        return {
          list: this.list,
          items: this.items,
          challengePeriod: this.list?.challengePeriod,
        };
      }
